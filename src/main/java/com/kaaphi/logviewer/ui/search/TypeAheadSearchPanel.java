...
public class TypeAheadSearchPanel extends JTextField {
  private static final Logger log = Logger.getLogger(TypeAheadSearchPanel.class);

  private boolean reverse = false;
  private TypeAheadSearchSession search;
  ...
  public TypeAheadSearchPanel(final TypeAheadSearchSession search) {
    this.search = search;
